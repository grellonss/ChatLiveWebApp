      ...
      <h1 className='text-3xl font-semibold text-center text-gray-300'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className='label p-2'>
            ...
            <input type='text' placeholder='Fabio Grelloni' className='w-full input input-bordered h-10' value={inputs.fullName} onChange={(e) => setInputs({...inputs,fullName: e.target.value})}/>
          </div>
          ...
          <div>
            ...
            <input type='text' placeholder='grellonss' className='w-full input input-bordered h-10' value={inputs.username} onChange={(e) => setInputs({...inputs,username: e.target.value})}/>
          </div>
      ...
      <h1 className='text-3xl font-semibold text-center text-gray-300'>
        ...
        <form>
          ...
          <label className='label p-2'>
            ...
            <input type='text' placeholder='Fabio Grelloni' className='w-full input input-bordered h-10 '/>
          </div>
          ...
          <div>
            ...
            <input type='text' placeholder='grellonss' className='w-full input input-bordered h-10 '/>
          </div>
